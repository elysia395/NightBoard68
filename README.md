...
> **当前版本：v1.3.2**（基于上游 [v1.2.1](https://github.com/elysia395/NightBoard68/releases/tag/v1.2.1)，
> 版本号与上游仓库对齐。本分支全部改动点见下方
> [「v1.3.2 改动点」](#v132-改动点相对-v131)、
> [「v1.3.1 改动点」](#v131-改动点相对-v130)
> 与 [「v1.3.0 改动点」](#v130-改动点相对上游-v121)）
